...
try:
    ...
    print("DataLoader relative import failed")

try:
    from model.model import Model
except ImportError:
    print("Model relative import failed")

try:
    from trainers.trainer import Trainer
except ImportError:
    print("Trainer relative import failed")

try:
    from utils.config_parser import process_config_file
except ImportError:
    print("process_config_file relative import failed")

try:
    from utils.dirs import create_dirs
except ImportError:
    print("create_dirs relative import failed")

try:
    from utils.logger import Logger
except ImportError:
    print("Logger relative import failed")

try:
    from utils.utils import get_args
except ImportError:
    print("get_args relative import failed")
